...
motor[Chasis_L3]=0;
	...
	void PARK_BLUE_MIDDLE_FLAGS(){
		...
		// GO UP TO SHOOT MIDDLE SECTION FLAGS
		Sonar_Chasis_RB(75, -75);

		// TURN TO FACE MIDDLE SECTION FLAGS
		SensorValue[D_gyro] = 0;

		// TURN 45 DEGREES FACING MIDDLE FLAGS
		turn(1275, 35);

		// GO TO LINE ON PLATFORM
		Chasis(-75, 5, false);
		...
		//BANG THE WALL
		Sonar_Chasis_RB(5, -75);

		// LINE UP ROBOT FOR PLATFORM
		Sonar_Chasis_FB(85, 75);
...
task autonomous()
{
	...
	//Parking_Blue_Top();
	//Parking_Blue_Bottom();
  //PARK_BLUE_MIDDLE_FLAGS();
  //PARK_RED_MIDDLE_FLAGS();
  //RED_FLAGS();
  BLUE_FLAGS();
  //PARK_BLUE_CAP();
}
