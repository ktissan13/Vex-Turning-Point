...
#pragma config(Sensor, dgtl9,  Catapult_Pot,   sensorQuadEncoder)
#pragma config(Motor,  port1,           Catapult_1,    tmotorVex393HighSpeed_HBridge, openLoop, reversed)
...
#pragma config(Motor,  port5,           Chasis_R1,     tmotorVex393HighSpeed_MC29, openLoop, driveRight, encoderPort, dgtl5)
