...
task usercontrol()
{
	...
	while (true)
	{
		if (vexRT(Btn8UXmtr2)==1||vexRT(Btn6U)==1){
			//BRAKE
			//main controller
			motor[Chasis_L1]=50;
			motor[Chasis_L2]=-50;
		...
		if (SensorValue(Catapult_Pot ) > Final_Value-400){
			Ball_Intake((127*vexRT(Btn6UXmtr2)) + (-127*vexRT(Btn6DXmtr2)));
		}
		else{
			motor[Ball_Intake_2] = ((127*vexRT(Btn6UXmtr2)) + (-127*vexRT(Btn6DXmtr2)));
		}
