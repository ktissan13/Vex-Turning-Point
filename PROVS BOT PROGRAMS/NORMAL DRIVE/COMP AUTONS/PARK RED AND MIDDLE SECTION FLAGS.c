...
task autonomous()
{
	...
	/*---------------------------------------------------------------------------*/ /*GO HIT THE MIDDLE SECTION FLAGS*/

	// GO BACK FROM THE PLATFORM TO SHOOT MIDDLE FLAGS
	Sonar_Chasis_RB(75, -75);

	// TURN TO ANGLE TOWARDS THE MIDDLE FLAG
	PIDbaseTurn(120, 1, 75);

	// GO UP A BIT
	PIDbaseControl(5, 1, 100);
	...
	// TURN FACING BLUE SIDE
	PIDbaseControl(-120, 1, -75);
