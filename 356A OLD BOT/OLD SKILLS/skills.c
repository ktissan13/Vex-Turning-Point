...
task autonomous()
{
	...
	// USE SONAR TO GO TO BALL
	Sonar_Chasis_F(115,100);

	// STOP CHASSIS
	Chasis(0, 2, true);

	// USE SONAR TO GO BACK TO TILE
	Sonar_Chasis_R(30,-100);
	...
	// GO BACK TO ALLIGN TO FLAGS
	Chasis(127, 16, false);

	// SHOOT BALLS
	Catapult_Launch();

	// USE GYRO TO TURN TO WALL
	turn(775, -50);

	// USE SONAR TO HIT WALL TO LINE UP
	Sonar_Chasis_R(20, -100);
